...
78/78 项核心测试、Windows 编译、原生交互和精简包启动检查已通过；已检查默认及紧凑窗口截图。试用包见 [PR #8](https://github.com/yearliny/workguard/pull/8)，尚未合并或发布到 Releases。具体范围、数据升级及仍需实机体验的项目见 [每日维护实现说明](docs/DAILY-MAINTENANCE.md)。
