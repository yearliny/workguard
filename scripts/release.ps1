...
- 概览新增环形工作节奏、清晰的信息层级和七日连续工作趋势图。
- 休息页升级为沉浸场景：离线拱廊远景、环形倒计时、柔和配色与自适应布局。
- 页面进入、按钮反馈、动作切换、背景色和进度加入短时动画；没有循环背景动画。
- 设置 → 减少打扰可开启「减少动态效果」，并遵循 Windows 动画偏好。
- 保留强制休息和紧急退出；43 项核心测试与 Windows 原生界面、动画、发布包检查。
