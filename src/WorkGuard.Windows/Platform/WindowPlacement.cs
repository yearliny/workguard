...
{
    public static void Place(Window window, bool fullscreen, bool corner = false, bool topmost = true)
    {
        ...
        SetWindowPos(handle, new IntPtr(topmost ? -1 : -2), left, top, width, height, 0x0010);
    }
